...
input_html = """
<input type="number" id="vekt_input" name="vekt_input" placeholder="Vekt (kg)" style="width: 100%; padding: 10px; font-size: 16px;">
"""
vekt_input = st.markdown(input_html, unsafe_allow_html=True)
